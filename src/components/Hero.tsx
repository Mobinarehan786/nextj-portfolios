...
import example from "../../public/girlimage.jpg";
import "./Hero.css";
      ...
      <section id="home" className="home">
        <div className="home-content">
          ...
          <div className="info-box">
            <div className="emai-info">
              <h5>Email:</h5>
              <span>eramahmed@rocketmail.com</span>
            </div>
            <div className="behance-info">
              <h5>behance:</h5>
              <span>behance.net/mobinakhatoo</span>
            </div>
          </div>
        ...
        <div className="home-image">
          <div className="image-box">
            <Image src={example} alt="alishba" height={280} width={280} />
          </div>
